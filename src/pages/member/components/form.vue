<template>
  <div class="container " style="min-height: 597px;">
    <div class="section section-first">
      <div class="block form js-form">
        ...
        <div class="block-item" style="border-top:0;">
          <label>收货人</label>
          <input type="text" placeholder="请输入姓名" name="user_name" :value="instance.name" maxlength="20" v-model='name'>
        </div>
        <div class="block-item">
          <label>联系电话</label>
          <input type="tel" placeholder="联系电话" name="tel" :value="instance.tel" maxlength="11" v-model='tel'>
        </div>
        <div class="block-item">
          <label>选择地区</label>
        ...
        <div class="block-item">
          <label>详细地址</label>
          <input type="text" placeholder="街道门牌信息" name="address_detail" :value="instance.address" maxlength="100" v-model='address'>
        </div>
      </div>
    </div>
    ...
    <div class="block section js-delete  block-control-btn" v-if="type==='edit'" @click='cartremove()'>
